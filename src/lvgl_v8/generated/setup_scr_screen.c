...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_img_set_src(ui->screen_img_1, &_SLL_alpha_450x450);
    lv_img_set_pivot(ui->screen_img_1, 50,50);
    lv_img_set_angle(ui->screen_img_1, 0);
    lv_obj_set_pos(ui->screen_img_1, -30, 0);
    lv_obj_set_size(ui->screen_img_1, 450, 450);
    ...
    lv_obj_set_pos(ui->screen_analog_clock_1, 45, 75);
    lv_obj_set_size(ui->screen_analog_clock_1, 300, 300);
